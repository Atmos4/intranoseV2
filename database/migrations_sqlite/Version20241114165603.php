...
final class Version20241114165603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orm_vehicles (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, manager_id INTEGER DEFAULT NULL, event_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, start_location VARCHAR(255) NOT NULL, return_location VARCHAR(255) NOT NULL, capacity VARCHAR(255) NOT NULL, CONSTRAINT FK_744369D0783E3463 FOREIGN KEY (manager_id) REFERENCES orm_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_744369D071F7E88B FOREIGN KEY (event_id) REFERENCES orm_events (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
