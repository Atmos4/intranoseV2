 ...
 */
final class Version20260410121601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orm_team_groups (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, event_id INTEGER DEFAULT NULL, activity_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, relay_format VARCHAR(255) DEFAULT NULL, published BOOLEAN NOT NULL, CONSTRAINT FK_20A5426971F7E88B FOREIGN KEY (event_id) REFERENCES orm_events (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_20A5426981C06096 FOREIGN KEY (activity_id) REFERENCES orm_activities (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE orm_teams (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, team_group_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, relay_format VARCHAR(255) DEFAULT NULL, slot_order VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_CCFF8E7446160539 FOREIGN KEY (team_group_id) REFERENCES orm_team_groups (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
